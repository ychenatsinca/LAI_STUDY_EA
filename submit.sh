...
cd /work/ychen/scripts/R/Rscripts/LAI_STUDY_EA/
...
log_file="w_${arg1}_p_${arg2}_window_${arg3}_offset_${arg4}_pos_${arg5}_track_${arg6}.log"
#
TARGET_KEY="work_dir"
REPLACEMENT_VALUE="\/work\/ychen\/scripts\/R\/Rscripts\/LAI_STUDY_EA\/"
